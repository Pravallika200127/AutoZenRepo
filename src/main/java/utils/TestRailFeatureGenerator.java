...
public class TestRailFeatureGenerator {
    ...
    public void generateFeatures(int projectId, int suiteId, String outputDir) throws Exception {
        ...
        StringBuilder featureFile = new StringBuilder("Feature: Auto-generated from TestRail\n\n");
        ...
        System.out.println("✅ Generated feature file at " + outputDir + "/testrail.feature");
    }
}
